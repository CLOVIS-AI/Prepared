...
=== "Kotlin-test"
    ...
    To decide whether it is appropriate for your project, see the available platforms and see the required configuration, refer to [the reference](../api/runner-kotlin-test/index.md).
...
=== "TestBalloon"
    ...
    To decide whether it is appropriate for your project, see the available platforms and see the required configuration, refer to [the reference](../api/runner-testballoon/index.md).
...
=== "Kotest"
    ...
    To decide whether it is appropriate for your project, see the available platforms and see the required configuration, refer to [the reference](../api/runner-kotest/index.md).
...
=== "Without a runner"
	...
	To do this, simply declare a dependency on `dev.opensavvy.prepared:suite`. To learn more, refer to [the reference](../api/suite/index.html).
