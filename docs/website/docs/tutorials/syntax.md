...
A test is declared by calling the [`test`](../api/suite/opensavvy.prepared.suite/-suite-dsl/index.md#test) function within a suite:
...
Tests are grouped in suites. Suites are declared by calling the [`suite`](../api/suite/opensavvy.prepared.suite/-suite-dsl/index.md#suite) function within another suite. Suites can be arbitrarily nested:
