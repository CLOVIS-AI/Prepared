...
!!! info "Configuration"
    ...
    See the [reference](../api/compat-parameterize/index.md).
...
To learn more about this module, and the way it interacts with [prepared values](prepared-values.md), see [the reference](../api/compat-parameterize/index.md).
