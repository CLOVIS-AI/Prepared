...
To start a task in the foreground, use [`launch`](../api/suite/opensavvy.prepared.suite/-test-dsl/index.md#launch) within a test:
```kotlin
...
To start a task in the background, use [`launchInBackground`](../api/suite/opensavvy.prepared.suite/-test-dsl/index.md#launchinbackground) within a test:
```kotlin
...
To allow the service to create foreground or background tasks, pass it either [`foregroundScope`](../api/suite/opensavvy.prepared.suite/-test-dsl/index.md#foregroundscope) or [`backgroundScope`](../api/suite/opensavvy.prepared.suite/-test-dsl/index.md#backgroundscope):
