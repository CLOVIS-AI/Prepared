# Control the flow of time in your Kotlin tests

Tests run in virtual time: a fixed timescale which is controlled by the developer.

The current virtual time can be accessed using the [`time.nowMillis`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/now-millis.html) property.
...
!!! warning
    ...
    - If the service accepts a `CoroutineContext`, see [`time.scheduler`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/-time/scheduler.html).
...
See [`time.source`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/-time/source.html):
...
=== "KotlinX.Datetime"
    ...
    See the [reference](https://prepared.opensavvy.dev/api-docs/compat/compat-kotlinx-datetime/index.html).

=== "Java Time"

    Add a dependency on `dev.opensavvy.prepared:compat-java-time`.
    See the [reference](https://prepared.opensavvy.dev/api-docs/compat/compat-java-time/index.html).

### Accessing the current time

=== "Kotlin.time"

    [`time.now`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/now.html) can be used to access the current time as an `Instant`:
...
=== "KotlinX.Datetime"
    ...
    [`time.now`](https://prepared.opensavvy.dev/api-docs/compat/compat-kotlinx-datetime/opensavvy.prepared.compat.kotlinx.datetime/now.html) can be used to access the current time as an `Instant`:
...
=== "Java Time"
    ...
    [`time.nowJava`](https://prepared.opensavvy.dev/api-docs/compat/compat-java-time/opensavvy.prepared.compat.java.time/now-java.html) can be used to access the current time as an `Instant`:
...
=== "Kotlin.time"
    ...
    By default, the virtual time is set to UNIX Time 0, January 1st, 1970 at 00:00:00. To set the initial time to another initial date, use [`time.set`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/set.html):
...
=== "KotlinX.Datetime"
    ...
    By default, the virtual time is set to UNIX Time 0, January 1st, 1970 at 00:00:00. To set the initial time to another initial date, use [`time.set`](https://prepared.opensavvy.dev/api-docs/compat/compat-kotlinx-datetime/opensavvy.prepared.compat.kotlinx.datetime/set.html):
...
=== "Java Time"
    ...
    By default, the virtual time is set to UNIX Time 0, January 1st, 1970 at 00:00:00. To set the initial time to another initial date, use [`time.set`](https://prepared.opensavvy.dev/api-docs/compat/compat-java-time/opensavvy.prepared.compat.java.time/set.html):
...
=== "Kotlin.time"
    ...
    Algorithms we want to test need to have access to the virtual time. Traditionally, this is done by accepting a `Clock` in the algorithm's constructor. We can generate such a clock with [`time.clock`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/clock.html):
...
=== "KotlinX.Datetime"
    ...
    Algorithms we want to test need to have access to the virtual time. Traditionally, this is done by accepting a `Clock` in the algorithm's constructor. We can generate such a clock with [`time.clock`](https://prepared.opensavvy.dev/api-docs/compat/compat-kotlinx-datetime/opensavvy.prepared.compat.kotlinx.datetime/clock.html):
...
=== "Java Time"
    ...
    Algorithms we want to test need to have access to the virtual time. Traditionally, this is done by accepting a `Clock` in the algorithm's constructor. We can generate such a clock with [`time.clockJava`](https://prepared.opensavvy.dev/api-docs/compat/compat-java-time/opensavvy.prepared.compat.java.time/clock-java.html):
...
=== "Kotlin.time"
    ...
    Instead of using `delay` to wait for a specific duration, we can also use [`delayUntil`](https://prepared.opensavvy.dev/api-docs/suite/opensavvy.prepared.suite/delay-until.html) to wait until a specific instant.
...
=== "KotlinX.Datetime"
    ...
    Instead of using `delay` to wait for a specific duration, we can also use [`delayUntil`](https://prepared.opensavvy.dev/api-docs/compat/compat-kotlinx-datetime/opensavvy.prepared.compat.kotlinx.datetime/delay-until.html) to wait until a specific instant.
...
=== "Java Time"
    ...
    Instead of using `delay` to wait for a specific duration, we can also use [`delayUntil`](https://prepared.opensavvy.dev/api-docs/compat/compat-java-time/opensavvy.prepared.compat.java.time/delay-until.html) to wait until a specific instant.
