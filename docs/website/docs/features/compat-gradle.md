...
!!! info "Configuration"
    ...
    See the [reference](../api/compat-gradle/index.md).
...
2.  Use the [`gradle`](../api/compat-gradle/opensavvy.prepared.compat.gradle/gradle.md) extension point and its [`settingsKts`](../api/compat-gradle/opensavvy.prepared.compat.gradle/-gradle/index.md#settingskts) function to create the `settings.gradle.kts` file.
