...
!!! info "Configuration"
    ...
    See the [reference](../api/compat-filesystem/index.md).

## Creating temporary files and directories

[New files](../api/compat-filesystem/opensavvy.prepared.compat.filesystem/create-random-file.md) and [new directories](../api/compat-filesystem/opensavvy.prepared.compat.filesystem/create-random-directory.md) can be created as [prepared values](prepared-values.md):
...
1.  The `/` operator can be used to refer to child files or directories before the test starts executing. [Learn more](../api/compat-filesystem/opensavvy.prepared.compat.filesystem/div.md).
...
On the JVM, it is possible to organize resources files in the same packages as source classes to avoid conflicts. To access these files, use the [resource](../api/compat-filesystem/opensavvy.prepared.compat.filesystem.resources/resource.md) helper:
